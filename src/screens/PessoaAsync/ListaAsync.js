...
export default function ListaPessoasAsyncStorage({ navigation, route }) {
  ...
  async function loadPessoas() {
    ...
    console.log("function LoadPessoa:", response)
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          ...
          >
            ...
            <Card.Actions>
              <Button onPress={() => navigation.push('FormAsync', { acao: editarPessoa, pessoa: item })}>
                Editar
              </Button>
              <Button onPress={() => {
      ...
      <FAB
        icon="plus"
        style={styles.fab}
        onPress={() => navigation.push('FormAsync', { acao: adicionarPessoa })}
      />
